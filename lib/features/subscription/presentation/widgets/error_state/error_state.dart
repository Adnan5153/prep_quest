...
/// Friendly error state shown when the Subscription controller
/// cannot read plans or process payments.
class SubscriptionErrorState extends StatelessWidget {
  const SubscriptionErrorState({
    super.key,
    this.title = 'Something went wrong',
    this.message = 'We could not load the subscription catalogue.',
