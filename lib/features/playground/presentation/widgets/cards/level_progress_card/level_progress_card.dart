...
import 'level_progress_surface.dart';
import 'level_progress_utils.dart';
import 'level_progress_visual.dart';

class LevelProgressCard extends StatelessWidget {
  const LevelProgressCard({super.key, required this.visual, this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: Semantics(
        label: LevelProgressSemanticResolver.labelFor(visual.state),
