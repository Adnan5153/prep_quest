...
/// Centralised tokens for the [AiExplanationCard] widget family.
///
/// All colours, gradients, durations, and decorative sizes used inside the
/// card are declared here so the surface stays visually consistent and easy
/// to retheme without touching widget code.
class AiExplanationConstants {
  const AiExplanationConstants._();
  ...
  /// Inner radius for content sections (tips, notes, code blocks).
  ...
  /// Internal spacing between body sections.
  static const double sectionGap = AppSpacing.lg;

  /// Spacing between consecutive bullet/numbered items.
  static const double listItemGap = AppSpacing.sm;

  /// Spacing between adjacent inline tokens.
  static const double inlineTokenGap = AppSpacing.xxs;
  ...
  static const Duration glowDuration = Duration(milliseconds: 2400);
...
/// Semantic tone for inline badges and section accents.
enum AiExplanationTone { insight, hint, tip, warning, error, success, info }
